  ...
  template: `
    ...
    >
      ...
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M8.81345 13.123C8.62245 13.123 8.42945 13.05 8.28345 12.903L5.90945 10.53C5.61645 10.237 5.61645 9.763 5.90945 9.47C6.20245 9.177 6.67645 9.177 6.96945 9.47L8.81345 11.312L13.0294 7.097C13.3224 6.804 13.7964 6.804 14.0894 7.097C14.3824 7.39 14.3824 7.864 14.0894 8.157L9.34345 12.903C9.19745 13.05 9.00545 13.123 8.81345 13.123Z"
        fill="black"
      />
    </svg>
  `,
